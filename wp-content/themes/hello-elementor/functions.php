 ...
 *
 * This function registers and enqueues a custom JavaScript file ('custom-script.js')
 * for use in the WordPress theme. It also specifies jQuery as a dependency and
 * loads the script in the footer of the webpage.
 */
...
function enqueue_custom_widget_script() {
	wp_enqueue_script('Backbone.ModalDialog', get_template_directory_uri() . '/js/Backbone.ModalDialog.js', array('backbone'), '1.0', true);
	wp_enqueue_script('backbone.validation', get_template_directory_uri() . '/js/backbone.validation.js', array('backbone'), '1.0', true);
	wp_enqueue_script('Backbone-modal-script', get_template_directory_uri() . '/js/Backbone-modal-script.js', array('backbone'), '1.0', true);
